// Lucide SVG inline (https://lucide.dev) — règle absolue : pas d'emoji dans l'UI Tanguy.
// SVG MIT license. On inline pour éviter une dep JS.
...
const ICONS = {
  ...
  edit:         '<path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"/><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/>',
...
export function icon(name, size = 20) {
  ...
  if (!paths) return `<span class="icon-fallback" aria-label="${name}">?</span>`;
  return WRAP(paths, size);
}

// Helper pour injecter dans le DOM après render
