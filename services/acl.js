...
const FIELD_WHITELIST = {
  ...
  projets:             ['Référence', 'Client', 'Statut', 'Phase commerciale', 'Statut chantier', 'Budget HT', 'Marge prévisionnelle', 'Date découverte', 'Date pose prévue', 'Date pose fin', 'Heure début pose', 'Heure fin pose', 'Équipe pose', 'Note pose', 'Description', 'Journal chantier', 'Artisans', 'Type de projet', 'Architecte', 'Motif refus', 'Note refus', 'Date refus', 'Retenue montant', 'Retenue type', 'Retenue motif', 'Retenue statut', 'Retenue date', 'Retenue levée prévue'],
  ...
  fournisseurs:        ['Nom', 'Famille', 'Email', 'Téléphone', 'Adresse', 'Notes', 'Catégories'],
