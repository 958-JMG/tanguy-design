...
export function renderAdmin(app) {
  ...
  app.innerHTML = `
    ...
    <div class="kpi-row">
      <div class="kpi-card"><div class="kpi-label">Marges par projet</div><div class="muted">Sprint 5+</div></div>
      <div class="kpi-card"><div class="kpi-label">Stock</div><div class="muted">Sprint 5+</div></div>
      <div class="kpi-card"><div class="kpi-label">Artisans + rétro 5 %</div><div class="muted">Sprint 5+</div></div>
      <div class="kpi-card"><div class="kpi-label">Fournisseurs / familles</div><div class="muted">Sprint 5+</div></div>
